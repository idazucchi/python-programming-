...
# Given matrix M returns the position that holds the highest value
# in the last row or column
def highest_score_position(Matrix):
	best_val = Matrix[m][n]
	best_position = [m,n]
	# Maximum for the last column
	for row in range(m+1):
		val = Matrix[row][n]
		if val>best_val:
			best_position = [row, col]
			best_val = val
	# Maximum for the last row
	for col in range(n+1):
		val = Matrix[m][col]
		if val>best_val:
			best_position = [row, col]
			best_val = val
	#~ print(best_position, M[best_position[0]][best_position[1]])
...
sq1 = 'AGATTACC'#GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG'
sq2 = 'GATTAA'#GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG'
n = len(sq1)
m = len(sq2)
print(sq1, sq2,'\n')
...
########  TRACE-BACK  ########  
# Select beginning traceback cell --> P(m-1,n) or P(m,n-1)
